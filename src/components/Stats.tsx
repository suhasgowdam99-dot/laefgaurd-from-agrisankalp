...
export const Stats = () => {
  const stats = [
    { value: '4', label: 'COSTLY PLANT VARIETIES', color: 'text-green-600' },
    { value: '99.9%', label: 'DETECTION ACCURACY', color: 'text-green-600' },
    { value: 'SUPABASE', label: 'REAL-TIME DATABASE', color: 'text-green-600' },
  ];
